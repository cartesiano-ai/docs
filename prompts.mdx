...
###Position Distribution This bar shows how often your brand appears in each tier across all runs:
...
###Sources Cited This table lists the websites or publications most frequently referenced by the LLMs when generating answers. You’ll see:
